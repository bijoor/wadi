...
export interface CreateOpts {
  /** Register the tools that talk to a locally running Wadi app (view_3d/capture_3d).
   *  Default true. A remote/hosted host sets this false — it can't reach the user's app. */
  appBridge?: boolean;
...
// ---- app-bridge tools (need a Wadi app running on the SAME machine) ----------
if (appBridge) {
// ---- wadi_view_3d ------------------------------------------------------------
server.registerTool(
  "wadi_view_3d",
