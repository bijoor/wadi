...
data-model docs, and is a first-class DSL citizen: `spiral_staircase "S" (120, 120,
45, 110, 1.75)` compiles, its fields validate, and the editor autocompletes them.
...
**Live proof:** in the WDL playground, `spiral_staircase "Stair" (120,120,45,110,
1.75)`, authored purely through the generic DSL path, renders as wooden treads
