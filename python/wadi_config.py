...
if __name__ == "__main__":
    ...
    # ========================================================================
    # 2D SVGs (floor plans + elevations) are now generated by the browser
    # editor at docs/editor/ (or via the CLI: `scripts/regen_svgs.sh`).
    # The Python SVG generators in svg_2d.py are kept as a byte-identical
    # reference for the editor's parity harnesses — they can still be
    # invoked manually below if you want SVGs out of the Blender session.
    # See PLAN_REFACTOR.md (phases R1–R2) for the rationale.
    # ========================================================================

    # generate_all_floor_plans(HOUSE_CONFIG)
    # generate_all_elevations(HOUSE_CONFIG)
    # generate_combined_floor_plans(HOUSE_CONFIG)
    # generate_combined_elevations(HOUSE_CONFIG)

    # ========================================================================
    # WEB EXPORT - export GLB for the model viewer on GitHub Pages
    # ========================================================================
