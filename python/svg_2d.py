...
<head>
    ...
    <title>Wadi - 3D Model Viewer</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
def _create_readme(readme_path: str):
    ...
    readme_content = """# Wadi - 3D Model Viewer
...
- **wadi.glb** - 3D model file (glTF binary format)
