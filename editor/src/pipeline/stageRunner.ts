// Composition runner — the domain-neutral heart of the compositor
// (plans/primitive-componentization.md §2.5c).
//
// The compositor is a PURE, deterministic DAG of stages: each stage is a pure
