// The .wdl language cheat-sheet shown in the WDL editor's Reference slide-over
// (the 📖 button in the WDL pane header). Lazy-loaded with the editor so it never
// weighs on a visitor who leaves the WDL pane closed. Kept in sync with
// wadi.langium by hand; the in-editor Langium LSP supplies live hover/completion,
// this is the browsable overview alongside it.
